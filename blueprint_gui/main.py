...
INBOUND_PROTOCOL_HINT: dict[str, str] = {
    ...
    "Knowledge_Raw":  "Protocol: P8_Knowledge_Audit — verifies + enriches KB with .meta.yaml sidecars",
...
PROMPT_PHASES: list[tuple[str, str, str, str, str, str]] = [
    ...
    ("generation", "🔬", "P2",   "P2 · Research",
     "Conduct structural R&D with web enrichment and RAG-confidence checks",
    ...
    ("generation", "📐", "P3",   "P3 · Analysis",
     "Decompose features → Use Cases with stability-warnings and dependency tracking",
    ...
    ("generation", "⚙️", "P4",   "P4 · Dev Sync",
     "Decompose into Tasks + Fuzzing + validate horizontal dependencies",
    ...
    ("execution",  "⚡", "E1",   "E1 · Sprint Execution",
     "Execute task with TDD + sidecar metadata (source, confidence) harvesting",
    ...
    ("knowledge",  "🧹", "P8",   "P8 · Knowledge Audit",
     "Perform RAG lifecycle management: verify, prune, and enrich internal memory",
     "protocols/knowledge/P8_Knowledge_Audit.md"),
    # ── Reverse Engineering ──
    ...
    ("re", "🩺", "RE4",  "RE4 · Debt Scanner",
     "Scan critical debt + enrich undocumented code found via web research",
