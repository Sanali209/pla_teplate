...
PROMPT_MAP: dict[str, str] = {
    ...
    "p8_knowledge_audit":  BLUEPRINT_ROOT / "protocols" / "knowledge" / "P8_Knowledge_Audit.md",
    # Meta protocols
    "meta_rules":          BLUEPRINT_ROOT / "protocols" / "meta" / "Metadata_Schema.md",
...
DESCRIPTIONS: dict[str, str] = {
    ...
    "p2_research":  "Conduct R&D with web enrichment and RAG-confidence checks",
    "p2_5_ui_architecture": "Design the UI architecture for a feature",
    "p3_analysis":  "Feature analysis with stability index and dependency tracking",
    "p4_dev_sync":  "Generate tasks with horizontal dependency validation",
    "e1_sprint_execution": "Atomic execution with sidecar metadata harvesting",
    "meta_rules":   "Metadata schema and file naming rules for all artifacts",
    "self_critic":  "Review artifact for logic gaps and circular dependencies",
    ...
    "p8_knowledge_audit": "Perform lifecycle management: verify, prune, and enrich RAG knowledge",
    # Meta
    "meta_rules":   "Metadata schema and file naming rules for all artifacts",
